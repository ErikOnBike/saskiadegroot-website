CKEDITOR.editorConfig = function(config) {
	...
	config.allowedContent = "div[*](*);p;br;ul(no-bullets);ol;li;h1(title,drawing-background,coaching-background,guiding-background,art-background);h2;b;i;s;sub;sup;a[*](mailsecurity,telsecurity);img[src,title,data-thumbnail,data-selection,data-title-nl,data-title-en]{margin-left,margin-top,width}(*);svg[*];use[*];iframe[*](gcal,desktop,mobile,gmaps)"; 
